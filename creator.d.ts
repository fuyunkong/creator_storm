	...
	*/
	...
	export enum Macro {		
		...
		*/
		...
		var textureAtlas = new cc.TextureAtlas("res/hotUpdateTools.png", 3);
		
		2. //creates a TextureAtlas with texture
		var texture = cc.textureCache.addImage("hotUpdateTools.png");
		...
		*/
		...
		textureAtlas.initWithTexture("hotUpdateTools.png", 3);
		...
		*/
		...
		```js
		------------------
		var key = cc.textureCache.textureForKey("hotUpdateTools.png");
		...
		*/
		...
		```js
		------------------
		var key = cc.textureCache.getTextureForKey("hotUpdateTools.png");
		...
		*/
		...
		```js
		------
		cc.textureCache.removeTexture("hotUpdateTools.png");
		...
		*/
		...
		```js
		----
		cc.textureCache.addImage("hotUpdateTools.png");
